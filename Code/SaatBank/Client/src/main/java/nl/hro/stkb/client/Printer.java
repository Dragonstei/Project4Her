...
public class Printer {
    ...
    public String reknr[] = {"Rek. Nummer : ", "reknr"};
    public String bedrag = "Opgenomen: ";
    public String bedankt = "Bedankt en tot ziens";
    public String transactie = "Transactienummer";
    public String transacnmr;

        public Printer(String iban, String opgenomen, int transactienummer) {
        reknr[1] = iban;
        bedrag = "Opgenomen :  $"+opgenomen;
        transacnmr = Integer.toString(transactienummer);
        
            PrinterJob pj = PrinterJob.getPrinterJob();
            mPageFormat = new PageFormat();
            Paper paper = new Paper();
            mPageFormat.setOrientation(mPageFormat.PORTRAIT);
    ...
    public void makeGraphics(Graphics2D g3) {
        ...
        g3.drawString(transactie, 10, 75);
        g3.drawString(transacnmr, 10, 90);
        g3.drawString(datum, 10, 105);
        g3.setFont(new Font("Monospaced", Font.BOLD, 14));
        g3.drawString(line, 10, 115);
        g3.setFont(new Font("Monospaced", Font.BOLD, 12));
        g3.drawString(reknr[0], 10, 150);
        g3.drawString(reknr[1], 10, 165);
        g3.drawString(bedrag, 10, 195);
        g3.drawString(bedankt, 10, 255);
    }
